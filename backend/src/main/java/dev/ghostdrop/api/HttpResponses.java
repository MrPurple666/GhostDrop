...
final class HttpResponses {
    private static final Map<String, String> HEADERS =
            Map.of(
                    ...
                    System.getenv()
                            .getOrDefault("GHOSTDROP_ALLOWED_ORIGIN", "http://localhost:5173"));
    ...
    static APIGatewayV2HTTPResponse notFound() {
        return response(
                404,
                "{\"code\":\"FILE_NOT_FOUND\",\"message\":\"This GhostDrop is no longer"
                        + " available.\"}");
    }
    ...
    static APIGatewayV2HTTPResponse internalError() {
        return response(
                500,
                "{\"code\":\"INTERNAL_ERROR\",\"message\":\"The request could not be"
                        + " completed.\"}");
    }
}
