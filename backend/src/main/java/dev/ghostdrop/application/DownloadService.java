...
public final class DownloadService {
    ...
    private final Function<String, String> downloadUrl;
    private final BiPredicate<String, String> passwords;
    private final Clock clock;

    public DownloadService(FileRepository repository, Function<String, String> downloadUrl, BiPredicate<String, String> passwords, Clock clock) {
    ...
    public Optional<String> create(String id, String password) {
        ...
        return repository.reserveDownload(id, clock.instant()).map(value -> downloadUrl.apply(value.storageKey()));
    }
}
